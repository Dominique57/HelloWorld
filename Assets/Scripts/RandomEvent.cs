...
public class RandomEvent{
	...
	public void ApplyChanges (){ //( 0f, 0, 0f, 0, null) for no changes
		...
		Debug.Log ("Applied changes of an event : transmission+=" + this.transmitionHuman + " ,virulence+=" + this.virulence + "and lethality+=" + this.lethality + ". This event also killed " + this.deceased + " people in the country " + this.country.Name);
	}
}
